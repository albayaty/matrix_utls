...
%          3.  Create (MxN) matrix of empty cells,
%          4.  Create (MxN) matrix of unique (int/float/letters) value,
%          5.  Create (MxN) matrix of random (int/float) values,
%          6.  Create Identity (MxM) matrix,
